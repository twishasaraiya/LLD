...
public class DeliveryManagerImpl implements DeliveryManager {
     ...
     *
     *
     *  Fallouts with original design
     *
     * 1. you are fetching all available delivery executors ? - do we need this?
     *          - Can we fetch only the ones that are nearest to the restaurant
     ...
     *
     * 3. delivery executor might accept or decline so what should be done in this case? - Expected to clarify during the intitial think through
     *
     ...
     *
     * TAKEAWAYS
     * - Watch Keerti's zomato low level design
     * - Observer pattern
     */
    @Override
